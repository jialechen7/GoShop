...
type UserGetListCommonReq struct {
	g.Meta `path:"/user/list" tags:"用户后台" method:"get" summary:"获取用户列表接口"`
	CommonPaginationReq
}
...
type UserUpdateReq struct {
	g.Meta       `path:"/user/update" method:"post" tags:"用户后台" summary:"修改用户接口"`
...
type UserDeleteReq struct {
	g.Meta `path:"/user/delete" method:"delete" tags:"用户后台" summary:"删除用户接口"`
