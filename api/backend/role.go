...
type RoleCreateReq struct {
	g.Meta `path:"/role/add" method:"post" summary:"添加角色" tags:"角色后台"`
...
type RoleUpdateReq struct {
	g.Meta `path:"/role/update" method:"post" summary:"更新角色" tags:"角色后台"`
...
type RoleDeleteReq struct {
	g.Meta `path:"/role/delete" method:"delete" summary:"删除角色" tags:"角色后台"`
	Id     int `json:"id" v:"required#请输入角色ID"`
}
...
type RoleGetListCommonReq struct {
	g.Meta `path:"/role/list" tags:"角色后台" method:"get" summary:"角色列表接口"`
	CommonPaginationReq
}
...
type RoleAddPermissionsReq struct {
	g.Meta        `path:"/role/add/permission" method:"post" summary:"添加角色权限" tags:"角色后台"`
...
type RoleDeletePermissionsReq struct {
	g.Meta        `path:"/role/delete/permission" method:"delete" summary:"删除角色权限" tags:"角色后台"`
	RoleId        int   `json:"role_id" v:"required#请输入角色ID"`
	PermissionIds []int `json:"permission_ids" v:"required#请输入权限ID"`
}
