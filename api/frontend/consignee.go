...
type ConsigneeGetListCommonReq struct {
	g.Meta `path:"/consignee/list" tags:"收货人前台" method:"get" summary:"收货人列表接口"`
	CommonPaginationReq
}
...
type ConsigneeAddReq struct {
	g.Meta    `path:"/consignee/add" tags:"收货人前台" method:"post" summary:"创建收货人接口"`
...
type ConsigneeDeleteReq struct {
	g.Meta `path:"/consignee/delete" method:"delete" tags:"收货人前台" summary:"删除收货人接口"`
	Id     int `v:"min:1#请选择需要删除的收货人" dc:"收货人id"`
}
type ConsigneeDeleteRes struct{}

type ConsigneeUpdateReq struct {
	g.Meta    `path:"/consignee/update" method:"post" tags:"收货人前台" summary:"修改收货人接口"`
