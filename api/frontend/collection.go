...
type CollectionGetListCommonReq struct {
	g.Meta `path:"/collection/list" tags:"Collection" method:"get" summary:"收藏列表接口"`
	CommonPaginationReq
...
type CollectionAddReq struct {
	g.Meta   `path:"/collection/add" tags:"Collection" method:"post" summary:"创建收藏接口"`
	Type     int `json:"type" form:"type" v:"required#请选择类型" dc:"类型"`
...
type CollectionDeleteReq struct {
	g.Meta `path:"/collection/delete" method:"delete" tags:"Collection" summary:"删除收藏接口"`
	Id     int `v:"min:1#请选择需要删除的收藏" dc:"收藏id"`
}
type CollectionDeleteRes struct{}

type CollectionDeleteByTypeReq struct {
	g.Meta   `path:"/collection/deleteByType" method:"delete" tags:"Collection" summary:"删除收藏接口"`
	Type     int `json:"type" form:"type" v:"required#请选择类型" dc:"类型"`
...
type CollectionUpdateReq struct {
	g.Meta `path:"/collection/update" method:"post" tags:"收藏" summary:"修改收藏接口"`
}
type CollectionUpdateRes struct{}

type CollectionDetailReq struct {
	g.Meta `path:"/collection/detail" method:"get" tags:"收藏" summary:"收藏详情接口"`
