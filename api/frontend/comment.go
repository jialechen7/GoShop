...
type CommentGetListCommonReq struct {
	g.Meta `path:"/comment/list" tags:"评论前台" method:"get" summary:"评论列表接口"`
	CommonPaginationReq
...
type CommentAddReq struct {
	g.Meta   `path:"/comment/add" tags:"评论前台" method:"post" summary:"创建评论接口"`
...
type CommentDeleteReq struct {
	g.Meta `path:"/comment/delete" method:"delete" tags:"评论前台" summary:"删除评论接口"`
	Id     int `v:"min:1#请选择需要删除的评论" dc:"评论id"`
}
type CommentDeleteRes struct{}

type CommentUpdateReq struct {
	g.Meta `path:"/comment/update" method:"post" tags:"评论前台" summary:"修改评论接口"`
}
